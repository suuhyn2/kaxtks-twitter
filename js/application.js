...
//
  var templates = {
    ...
    user_nav: Hogan.compile('<a href="#" class="icon-sprite icon-user dropdown-toggle" data-toggle="dropdown"></a><ul class="dropdown-menu"><li><a href="#user-info" data-toggle="modal"><i class="icon-user"></i>See account details</a></li><li class="divider"></li><li><a href="https://twitter.com/{{screen_name}}" target="_blank"><i class="icon-share-alt"></i>See profile on Twitter</a></li></ul>'),
    modal_header: Hogan.compile('<h3>Account details <span class="download-date muted">at {{created_at_relative}}</span></h3>'),
    ...
    modal_account_details: Hogan.compile('<p>#{{id}} <span class="footer-label muted">User identifier</span></p><p class="truncated">{{created_at_relative}} <span class="footer-label muted">Registred</span></p>'),
...
//
  ...
  exports.init = function () {
    ...
    .bind('invalidSearch', function (e) {
      e.preventDefault();
      $(this)
        .attr('data-original-title', 'Your request must have at least 2 characters.')
        .tooltip('show');
    });
  ...
  (function(exports) {
    exports.base = {
      init: function () {
        $('.navbar-search .search-query').attr('placeholder', 'Search in all tweets');
  ...
  (function (exports){
    ...
    exports.localizeStrings = function() {
      ...
      $('#footer-text').append("This is an offline archive of your Twitter tweets. Use the months below to navigate the archive.");
      var compose_new_tweet = "Write a new tweet";
